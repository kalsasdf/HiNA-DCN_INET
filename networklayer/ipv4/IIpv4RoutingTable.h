...
class INET_API IIpv4RoutingTable : public IRoutingTable
{
  public:
    ...
    //added by HiNA
//    virtual Ipv4Route *findreverseRoute(const Ipv4Address& src,const Ipv4Address& dest,Packet *packet) const = 0;

    virtual Ipv4Route *findecmpRoute(const uint32_t ifid_in,const Ipv4Address& src,const Ipv4Address& dest,Packet *packet) const = 0;
    //added by HiNA
